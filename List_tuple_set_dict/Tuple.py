#immutable
#you cannot update, add or delete
#you can access the value
# it is used when you want to keep the data static
...
# Nested Tuples
#here it first selects the whole (4,5,6) and then from this tuple it selects the element with the index 2
